...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(figure0, "class", "svelte-qo0i6c");
    			...
    			attr_dev(figure1, "class", "svelte-qo0i6c");
    			...
    			attr_dev(figure2, "class", "svelte-qo0i6c");
    			...
    			attr_dev(figure3, "class", "svelte-qo0i6c");
    			...
    			attr_dev(figure4, "class", "svelte-qo0i6c");
    ...
    // (29:2) {#each components as component}
    function create_each_block(ctx) {
    	let option;
    	let t0_value = /*component*/ ctx[4].idx + "";
    	let t0;
    	let t1;
    	let t2_value = /*component*/ ctx[4].name + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			t2 = text(t2_value);
    			option.__value = option_value_value = /*component*/ ctx[4];
    			option.value = option.__value;
    			add_location(option, file$2, 29, 3, 808);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:2) {#each components as component}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$2, 27, 1, 740);
    			add_location(header, file$2, 19, 0, 402);
    			attr_dev(main, "id", "slides");
    			add_location(main, file$2, 35, 0, 909);
    			add_location(h6, file$2, 43, 1, 1068);
    			add_location(footer, file$2, 42, 0, 1058);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [selected, components, idx, select_change_handler];
    }
