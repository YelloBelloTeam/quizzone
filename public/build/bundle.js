    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 35, 3, 2202);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 26, 1, 1805);
    			add_location(br, file$3, 27, 62, 1898);
    			add_location(p, file$3, 27, 1, 1837);
    			if (/*selected*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[5].call(select));
    			add_location(select, file$3, 33, 1, 2134);
    			add_location(header, file$3, 25, 0, 1795);
    			attr_dev(main, "id", "slides");
    			add_location(main, file$3, 41, 0, 2304);
    			add_location(h6, file$3, 46, 1, 2483);
    			add_location(footer, file$3, 45, 0, 2473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
