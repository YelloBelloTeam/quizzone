<script>
	...
	*/
	...
	const components = [
		{ idx: 1, name: 'Párosító', qtype: Parosito, q: ['/images/city.jpeg', '/images/transport.jpeg', 'A harmadik egy szöveges', '/images/animals.jpeg', '/images/nature.jpeg', '/images/people.jpeg'], a:['People', 'Nature', 'Animals', 'Transport', 'City'] },
		...
		{ idx: 4, name: 'Szabadválasz - vegyes', qtype: Szabad, q: ['/images/city.jpeg', '/images/transport.jpeg', 'A harmadik egy szöveges', '/images/animals.jpeg', '/images/nature.jpeg', '/images/people.jpeg', 'Az utolsó is szöveges'], a: [] },
